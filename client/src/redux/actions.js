import {
  SET_ALL_CARDS, SET_ALL_VALUES, CHANGE_BACKGROUND, RANDOMIZE_ALL, ADD_FAV, REMOVE_FAV, QUERY_CHECKBOXES, QUERY, ORDER, ORDER_BY, FILTER, IS_FAVORITES_TOGETHER, OPTIONS_SIDEBAR_CARDS_PER_PAGE, OPTIONS_SIDEBAR_RADIOS, OPTIONS_SIDEBAR_CHECKBOXES, FAVORITES_ICONS, AUTOSAVE_TOGGLE, LOAD_SETTINGS, SAVE_SETTINGS
} from "./action-types"
...
export const setAllValues = (user) => {
  return { type: SET_ALL_VALUES, payload: user }
}
